...
simplificación basada en cubrimiento logra una mayor reducción de objetivos\todoerror[inline]{De vuelta se me ocurre que con las palabras indicadas capaz puedo decir que hay una pista y luego en trabajo futuro usarla como motivación para continuar refinando el método | ya comenté al respecto, ojo!} que
la simplificación basada en K-Means, pero es menos eficiente.\todoremark[inline]{Me quedaba la duda si por eficiencia se daba a entender solo que es más lento y/o se podía entender que implicaba algo sobre la calidad del resultado | chavacano! es menos eficiente?}
...
Una de estas líneas de trabajo es la de realizar experimentos en la realidad \todoerror[inline]{cambiar por float de robots reales| No se entiende que se quiere decir con experimentos en la realidad? O es para hacerlo explicito? Digo porque el titulo de la subsection es así y en la presentación lo tengo así también | con una flota de robots reales?}
...
comunicación y localización ideales de los robots \cite{amigoni2017multirobot,slam}.
