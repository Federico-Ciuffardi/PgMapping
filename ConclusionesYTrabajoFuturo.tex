...
%     * se podria asignar dimendsiones mínimas de lso robots a las fronteras (para un camino tengo los vertices y cada uno tiene distancia mínima a los obstaculos entoces la mínima distancia a un obstaculo es tu dimencion maxima si no te vas a chochar). 
