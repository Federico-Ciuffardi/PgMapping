En este proyecto de grado se planteo\todo{Este ... se planteó ...} el objetivo de mejorar la solución del
...
que consiste en explorar\todo{ el entorno} maximizando la distribución de los robots sobre los
segmentos (habitaciones y corredores)\todo{invertiría pasaría segmentos al paréntesis y sacaría habitaciones  y corredores}, los cuales se identifican a partir de un
...
la cual se experimento\todo{experimentó} dentro de un simulador con el propósito de validar su
impacto.

En este ultimó capitulo\todo{capítulo} se plantean las conclusiones derivadas del trabajo
realizado en el proyecto de grado y se establecen líneas de trabajo que pueden ser
retomadas\todo{continuadas} en el futuro.
...
la simplificación basada en K-Means, pero lleva más tiempo\todo{chavacano! es menos eficiente?}.
...
Una de estas líneas de trabajo es la de realizar experimentos en la realidad\todo{con una flota de robots reales?}
...
comunicación ideal y de localización trivial\todo{comunicación y localización ideales?} de los robots\todo{sacar lo que sigue.}, dado que estas
...
aristas entre dichos vertices\todo{vértices} implique la adyacencia entre los segmentos.
...
describen en \cite{Thrun1998,Liu2015,wurm2008coordinated}\todo{colocar las refs en orden cronológico}.
