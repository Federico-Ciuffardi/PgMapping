...
problema de exploración multirobot propuesta en \cite{wurm2008coordinated},
...
problema de exploración multirobot en general relevando una serie de
potenciales mejoras. Estas fueron implementadas como parte de una solución al
problema de exploración multirobot\footnote{Disponible en línea:\\
...
módulos como nodos de ROS independientes, que sigan los estándares propuestos
...
Actualizar la solución actual que utiliza la primera versión de ROS (ROS 1)
para utilizar en su lugar a su segunda versión (ROS 2), puede ser otra línea de
trabajo de interés pensando en la reusabilidad a futuro, ya que ROS 1 termina
