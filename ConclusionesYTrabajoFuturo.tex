...
simplificación basada en K-Means es la más eficiente en términos de tiempo de
...
% método | ya comenté al respecto, ojo!} que la simplificación basada en
...
\todohint{Quedo bien la subsección? La reescribí para agregar que hay que comprobar cual de los métodos de simplificación es mejor}
% esta relacionada al
...
simplificación de fronteras basada en cubrimiento es mejor que la basada en K-Means
...
De comprobarse que el método de simplificación de fronteras basado en
cubrimiento logra
mejores reducciones de los objetivos identificados se abren dos líneas de
