...
\todohint{quedo bien? (Desde -Los resultados experimentales-)}

% logra una mayor reducción de objetivos\todoerror[inline]{De vuelta se me
% ocurre que con las palabras indicadas capaz puedo decir que hay una pista y
% luego en trabajo futuro usarla como motivación para continuar refinando el
% método | ya comenté al respecto, ojo!} que la obtención de fronteras significativas basada en
% K-Means, pero es menos eficiente.\todoremark[inline]{Me quedaba la duda si
% por eficiencia se daba a entender solo que es más lento y/o se podía entender
% que implicaba algo sobre la calidad del resultado | chavacano! es menos
% eficiente?} pero tiene un rendimiento inferior en términos de costo
% computacional.
...
\todohint{Quedo bien la subsección? La reescribí para agregar que hay que comprobar cual de los métodos de obtención de fronteras significativas es mejor}
% esta relacionada al
...
% algoritmos de obtención de fronteras significativas principalmente en la habitación grande del centro,
...
% generar las condiciones necesaria para que la obtención de fronteras significativas de K-Means
...
% Cuidado con la obtención de fronteras significativas y los obstáculos que pueden llegar a
