...
% \todoremark{La introducción a ros, no se si deberia estar aca. La parte de migrar se entiende? deberia fundamentar más? sacarla?}
...
cuando se encuentran a un metro de esta (información obtenida usando un LiDAR) %\footnote{Dispositivo que permite determinar la distancia desde un emisor láser a una superficie.}
...
% - Diferentes estandares en los sistemas coordenadas entre ROS("ENU") y
%   Webots("NUE") que aunque Webots permite cambiarlo esto solo altera las
...
%   fue la necesidad rotar los frames de referencia de los datos un lidar para
