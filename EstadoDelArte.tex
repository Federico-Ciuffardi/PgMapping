...
% En entornos estructurados, , como lo son las casas y oficinas, las regiones suelen ser estar asociadas a las habitaciones y corredores del entorno.

La simplicidad de los mapas topológicos es útil para ayudar a los humanos a entender un entorno (por esto es usual ver mapas topológicos de sistemas de transporte) y permiten instrucciones que nos resultan naturales, por ejemplo, \say{ir a la habitación A}. Otra ventaja es que por su simplicidad estos suelen ser mas compactos y por lo tanto pueden utilizarse para desarrollar técnicas de planificación eficiente.
