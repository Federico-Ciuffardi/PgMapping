...
\begin{figure}[H]
  ...
  \caption[Diagrama generalizado de Voronoi.]{Diagrama generalizado de Voronoi. Extraído de \cite{Wallgrun2005}}
  \label{cleanup}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Método de construcción de un mapa topológico.]{Método de construcción de un mapa topológico. Los números de las figuras (c) y (d) son identificadores arbitrarios de regiones. Extraído de \cite{Thrun1998}.}\label{fig:ejThrunTop}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption[Segmentación propuesta en \cite{Solanas2004}.]{Segmentación propuesta en \cite{Solanas2004}. Extraída de \cite{wu2007voronoi}.}\label{fig:ejemploCoodGrill}
\end{figure} 
