...
objetivos de exploración, y (ii) distribuir uno de dichos objetivos al robot\todo{está rara la redacción. digamos que si hablamos de distribuir es entre todos no a uno. por ahí me pareció rara.}
...
% \end{equation}
Dado un espacio euclídeo $W \subseteq \mathds{R}^2$, un conjunto de puntos $G \subseteq W$ llamados \emph{generadores} y la función $d_p : W \rightarrow \mathds{R}$ qué\todo[]{sin tilde} computa la distancia desde $p\in W$ a otro punto en $W$. 
...
y Webots\footnote{\url{http://cyberbotics.com}}\todo{colocaría la info al pié como referencias a sitios web con fecha de última visita}.
% Actualmente existe una gran variedad de simuladores robóticos, de los cuales se consideraron
...
todos menos ARGoS proveen de\todo{sacar 'de'} soporte oficial para \gls{ROS}. Para ARGoS existe una
