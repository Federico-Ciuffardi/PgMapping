...
dichos objetivos al robot. Para identificar objetivos de exploración, un método
...
otro lado para establecer que objetivo asignar al robot se suele decidir
cual de estos es el más conveniente, donde la conveniencia de un objetivo puede
