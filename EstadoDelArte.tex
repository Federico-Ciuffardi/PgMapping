...
\say{objetivo de exploración} se entiende uno de estos lugares convenientes. El
...
% Una \emph{region de Voronoi} $R_i\subset W$ es el conjunto de puntos más cercanos a un generador $s_i\in G$ particular: 
% \begin{equation}
