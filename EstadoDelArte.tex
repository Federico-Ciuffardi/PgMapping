...
la sección \ref{sec:coord} se describen algunas técnicas de coordinación para 
...
entorno con el propósito de generar planes para navegar en el entorno. El mapa topológico es
...
\begin{figure}[H]
  ...
  \caption[Ondas de brushfire dinámico.]{Una secuencia que ejemplifica las ondas generadas cuando se agregan obstáculos (1-5) y se eliminan obstáculos (6-10). (1-5) Se agrega nueva celda ocupada en el centro del entorno (en rojo) lo cual produce una onda consistente (en negro) que al chocar genera celdas pertenecientes al GVD (en gris). (6-10) La celda central deja de ser un obstáculo produciéndose una onda inconsistente (en azul) que remueve las celdas del GVD que involucran a la celda ocupada que paso a ser libre mientras que al llegar a cedas con una distancia mínima generar ondas inconsistentes (en negro) que reparan el GVD. Extraído de \cite{kalra2009incremental}.}\label{fig:ejWavesIncKarlra}
\end{figure} 
...
ocupada. Y al chocar dos ondas, las celdas en donde se da el choque
...
\begin{figure}[H]
  \center
  \centering
  \subfloat[Entorno]{\includegraphics[clip=true, width=0.45\linewidth]{imagenes/crits/a.png}\label{fig:crits:a}}
  \qquad
  \subfloat[GVD]{\includegraphics[clip=true, width=0.45\linewidth]{imagenes/crits/b.png}\label{fig:crits:b}}
  \qquad
  \subfloat[Puntos críticos]{\includegraphics[clip=true, width=0.45\linewidth]{imagenes/crits/c.png}\label{fig:crits:c}}
  \qquad
  \subfloat[Líneas críticas]{\includegraphics[clip=true, width=0.45\linewidth]{imagenes/crits/d.png}\label{fig:crits:d}}
  ...
  \caption[Puntos críticos y líneas críticas.]{Puntos críticos y líneas críticas. Notar que el despeje en puntos críticos se corresponde con el largo sus líneas críticas asociadas. Extraído de \cite{Thrun1998}.}\label{fig:crits}
...
\begin{figure}[H]
  ...
  \qquad
  \subfloat[líneas críticas]{\includegraphics[clip=true, width=0.45\linewidth]{imagenes/thrunTop/b.png}\label{fig:ejThrunTopB}}
  \qquad
...
independientes entre sí. Considerando esto, distribuir los robots sobre los
