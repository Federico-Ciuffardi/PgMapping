...
corresponden a puntos no obstaculizados del entorno y sus aristas $E_{MC}$ implican
...
El algoritmo de brushfire descrito hasta el momento no es incremental, pero en \cite{kalra2009incremental} se presenta una variante nombrada \emph{brushfire dinámico} que si lo es.
...
% \begin{itemize}
%   \item El paquete combina dos mapas $M_1$ y $M_2$ en un solo mapa global juntando dichos mapas de forma de maximizar la áreas que se solapan.
