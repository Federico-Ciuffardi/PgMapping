...
posible, siendo $R_{sim}$ (\ref{ec:R}) el indicador de rendimiento resultado de
dividir el tiempo dentro de simulación $ts$ entre el tiempo real que tome
ejecutarla $tr$. A mayor $R_{sim}$ mayor rendimiento.
...
Por el lado del rendimiento aunque las pruebas no relevancia estadistac
