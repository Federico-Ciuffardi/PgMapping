...
mas bajo de granularidad las reducciones son despreciables estas crecen junto a
la granularidad, hasta alcanzarse una reducción de ${\smallsim}29\%$ en el
nivel mas alto. Esto puede deberse al tiempo de asignación de tareas, por lo
explicado en la sección \ref{sec:exp:inc}. En este caso se considera que
principalemte son dos los factores que impactan a los tiempos de asignación de
tareas: el tiempo de simplificación de fronteras y la cantidad de objetivos
...
obtencion de información (sección \ref{subsec:obtInfo}) de la asignacion de
...
\ref{subsec:MiValSub}) y de resolución (sección \ref{subsec:MiResSub}) al ser
menor la cantidad de objetivos a valuar y asignar. Entonces lo que se evidencia
en los resultados obtenidos es que invertir tiempo en disminuir los obetivos
identificados simplificando las fronteras lleva a una reduccion total de los
tiempos de asignación de tareas y por lo tanto de los tiempos de exploración,
...
objetivos resultantes, se evitan las situaciones como las descritas lo cual 
puede verse como una coordinación pasiva. \todo{o implicita?}
...
pueden ser causadas por la disminución del tiempo de asignación de tareas, por
las mismas razones que en la seccion \ref{sec:exp:inc}. Aunque la coordinación
pasiva también puede estar jugando un rol al evitar que los robots se
transladen a objetivos que desaprovechan las capacidades sensoriales del robot
o que puedan llevar a inconvenientes en la navegacion.
...
Con respecto a los dos metodos que simplifican las fornteras en la
identificacion de objetivos, en el nivel de granularidad mas bajo, la
...
cubrimiento en todo nivel de granularidad es entre ${\smallsim}2$ y
${\smallsim}4$ veces mas lenta que la basada en K-Means. Estos resultados
...
tiempo se torna mas relevante que la reduccion de objetivos, resultando
superior la simplificación basada en K-Means. 
