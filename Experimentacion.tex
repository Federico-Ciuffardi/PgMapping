...
métodos son: la simplificación\todoerror[inline]{ lo puedo cambiar o no | Lo que entendí de lo que decís (y estoy de acuerdo) es que las fronteras como concepto no son más simples (no lo van a ser a no ser que cambie el mapa). La simplificación que digo yo va por el lado de la representación de ese concepto. 

  Nunca me refiero a las fronteras como el concepto si no que siempre hablo de una representación. A las fronteras las defino como el conjunto $F$ de todas las celdas frontera $(3.4)$ (creo que seria la forma atómica que decís), y las fronteras significativas $FS\subseteq F$ seria entonces una simplificación de $F$ que continua considerándose representativa de $F$ por cumplir la restricción de cubrimiento (creo que se mapa a los agrupamientos que decís). Por esto se me ocurrió el termino de -simplificación de fronteras-, por representar a las fronteras ($F$) de manera más simple (menos cantidad). 

  Para mi referirme a esto como -simplificación- da una mejor idea y queda más fácil de leer. De última podría cambiarlo simplemente por -fronteras significativas basadas en...-.

  | debo confesar que no me termina gustando el término. creo que no es del todo correcto porque no transmite realmente lo que se hace. es decir, lo que no se termina de hacer evidente es que una cosa son los puntos de frontera (celdas) y otro son las fronteras (conjuntos de celdas). entonces, no es que las fronteras son más simples sino que concibo los objetivos de forma atómica (puntos de frontera) o en agrupamientos (fronteras). ergo, intentaría aclarar el punto e iría por algo más del estilo: fronteras mediante máximo cubrimiento, fronteras mediante K-Means o puntos de frontera.} de fronteras basada en cubrimiento propuesta en
...
pero logra mejores reducciones de objetivos que la basada en K-Means\todoerror[inline]{Corregir aca, en las conclusiones y en el trabajo futuro. Tengo info en las notas | Entiendo y estoy de acuerdo que la pista que hay en los datos actuales no da para asegurarlo. Pero la pista que hace en estos datos me parece que algo vale. De ser así como puedo manejarlo? Acá trate de hacerlo con el -parecen indicar- quizás hay una expresión mejor que permita hacer énfasis en que es solo una posible explicación para esos resultados (la que hago en el siguiente párrafo).  | mmmm no. los resultados muestran que k-means es más rápido y que supera a la nuestra cuando aumenta la granularidad considerando distancia y tiempo medio de exp. para decir que las reducciones son mejores, habría que p.e. contar la cantidad de objetivos que se generan a lo largo de la exp con una u otra estrategia. eso daría una pista certera sobre el impacto de seguir una u otra y de allí se le podría atribuir que la nuestra distribuye mejor o hace mejores reducciones.}. En el
