...
A lo largo d esta se sección se especifican las pruebas realizadas en este proyecto.
...
Para evaluar la construcción incremental del GVD esta se compara contra la
construcción no incremental (sección \ref{subsec:constGVD}). En el caso de la
...
\url{https://gitlab.fing.edu.uy/federico.ciuffardi/pioneer_p3dx_model}} utilizados en las
...
primera asignación de tareas (sección \ref{sec:asigTar}) hasta que no se
...
de tareas (sección \ref{sec:asigTar}).
...
la etapa de obtención de información de cada asignación de tareas.
...
prueba los promedios y desviaciones estándar de las métricas, calculadas a partir de
las 20 repeticiones que se hacen debido al no determinismo del simulador.
