...
\ref{fig:gra:inc:gvdt}\todoremark[inline]{1: Saco las referencias a las gráficas de acá? 2: Quedo bien? Sobre todo la de sección de identificación de objetivos | referenciaría cada figura al final del párrafo que analiza el contenido asociado a ellas}.

\input{tablas/incrementalidad1}
% \todo[inline]{colocaría esta tabla inmediatamente a continuación de su referencia.}

En cada nivel de granularidad\todoerror[inline]{Entiendo, pero uso mucho el concepto de granularidad, en todos debería indicar que es la granularidad de la grilla? | de qué?} la variante incremental reduce en un
...
métodos son: la simplificación\todoerror[inline]{ Lo que entendí de lo que decís (y estoy de acuerdo) es que las fronteras como concepto no son más simples (no lo van a ser a no ser que cambie el mapa). La simplificación que digo yo va por el lado de la representación de ese concepto. 
