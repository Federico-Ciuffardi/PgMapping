...
\begin{figure}[H]
  ...
  \caption{Porcion del mapa de referencia y la misma porcion de un mapa resultante de una exploracion que presenta una celda explorable que no se reconoce como tal.}\label{fig:faltaCub}
   % A la izquierda se muestra el robot real, y a la derecha su version simulada.
