...
\ref{fig:gra:inc:gvdt}\todo{referenciaría cada figura al final del párrafo que analiza el contenido asociado a ellas}.

En cada nivel de granularidad\todo{de qué?} la variante incremental reduce en un
...
${\smallsim}8\%$ en el nivel de granularidad más bajo, y mediante\todo{conforme?} se aumenta el
...
pero logra mejores reducciones de objetivos que la basada en K-Means\todo{mmmm no. los resultados muestran que k-means es más rápido y que supera a la nuestra cuando aumenta la granularidad considerando distancia y tiempo medio de exp. para decir que las reducciones son mejores, habría que p.e. contar la cantidad de objetivos que se generan a lo largo de la exp con una u otra estrategia. eso daría una pista certera sobre el impacto de seguir una u otra y de allí se le podría atribuir que la nuestra distribuye mejor o hace mejores reducciones.}. En el
