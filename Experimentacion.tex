...
\ref{fig:gra:idobj:iobt}\todo{ídem sec anterior}.
...
pero logra mejores reducciones de objetivos que la basada en K-Means\todo[inline]{mmmm no. los resultados muestran que k-means es más rápido y que supera a la nuestra cuando aumenta la granularidad considerando distancia y tiempo medio de exp. para decir que las reducciones son mejores, habría que p.e. contar la cantidad de objetivos que se generan a lo largo de la exp con una u otra estrategia. eso daría una pista certera sobre el impacto de seguir una u otra y de allí se le podría atribuir que la nuestra distribuye mejor o hace mejores reducciones.}. En el
