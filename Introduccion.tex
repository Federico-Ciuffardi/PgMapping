...
a conocerse como el de exploración multirobot.
...
coordinación para la exploración multirobot en entornos estructurados que
...
Uno de los principales aspectos de la exploración multirobot es el de
...
solución al problema de exploración multirobot. Esta solución fue utilizada para
...
describe la solución al problema multirobot implementada. El capitulo
