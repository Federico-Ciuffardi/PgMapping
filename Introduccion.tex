...
humanas son entornos que pueden dividirse en segmentos, como como\todo{se repite como} habitaciones
...
mantiene igual con respecto a su ultima\todo{última} actualización, la reconstrucción
...
cantidades de objetivos puede ser computacionalmente restrictivo\todo{no queda claro que tener muchos objetivos hace más lenta y potencialmente menos eficiente la distribución. le dedicaría una oración a esto para aclarar.}. La
...
dejando robots ociosos\todo{reforzaría la idea agregando que además, los ociosos en un segmento podrían ser necesarios en otro(s)} La \textbf{cuarta contribución} consiste en un
...
segmento para evitar robot\todo{robots} ociosos.
