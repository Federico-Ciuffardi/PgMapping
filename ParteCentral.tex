...
multi-robot\footnote{Disponible en línea:\\
...
la exploración multi-robot, este proyecto se concentrara en algunos de ellos.
...
consideraciones especiales dependiendo de las dimensiones del robot. La (III) por
...
dimensiones suficientes para representar todo el entrono a explorar. 
...
entre los componentes. También es posible apreciar una simplificación de las
...
\begin{figure}[H]
  \centering
  \subfloat[Fronteras significativas obtenidas segun el método basado en K-Means.]{\includegraphics[clip=true, width=0.40\linewidth]{imagenes/fronterasigKMMal/caso1/a_sin_circ.png}}
  \qquad
...
\begin{figure}[H]
  \centerfloat
  \subfloat[Incializacion de $\mli{PF}$, $\mli{UF}$ y $\mli{FS_i}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/a2.png}}
  \subfloat[Se elige un nuevo $\mli{fs}$ y se actualizan $\mli{UF}$, $\mli{FS_i}$ y $\mli{PF}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/b5.png}}
  \subfloat[Se elige un nuevo $\mli{fs}$ y se actualizan $\mli{UF}$, $\mli{FS_i}$ y $\mli{PF}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/c5.png}}

  \subfloat[Se elige un nuevo $\mli{fs}$ y se actualizan $\mli{UF}$, $\mli{FS_i}$ y $\mli{PF}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/d5.png}}
  \subfloat[Se elige un nuevo $\mli{fs}$ y se actualizan $\mli{UF}$, $\mli{FS_i}$ y $\mli{PF}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/e5.png}}
  \subfloat[Se elige un nuevo $\mli{fs}$ y se actualizan $\mli{UF}$, $\mli{FS_i}$ y $\mli{PF}$.]{\includegraphics[clip=true, width=0.40\textwidth]{imagenes/ejemploSimpCub/f4.png}}
...
entrono explorado, dichas celdas representan la existencia de porciones del
entrono sin explorar. Dado que la definición del GVD no contempla el espacio
...
% exploración, a medida que se obtiene informacion (evidencia) sobre el entrono.
...
información obtenida del entrono.

Cada robot esta constantemente recopilando información del entrono a través de
sus sensores y enviando dicha información al nodo de ROS \emph{global\_costmap}
