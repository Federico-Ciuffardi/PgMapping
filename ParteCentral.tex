...
Los costos $\mli{cl}_{i,j}$ y $\mli{cc}_{i,j}$ tienen el propósito penalizar a
los objetivos $o_j$ que se estima que llevaría más tiempo para que $r_i$ los 
complete. Por otro lado el descuento $\mli{ds}_{i,j}$ incentiva que los
robots se mantengan explorando un mismo segmento, lo cual desencadena
comportamientos deseables como que un robot continue explorando un mismo
corredor, revelando rápidamente la estructura de un entorno.
