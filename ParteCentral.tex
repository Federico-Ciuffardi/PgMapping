...
esto se de define criterio que permite considerar cuando un punto del camino se
considera completado. Dado esto el funcionamiento del \emph{controlador de
movimiento} consiste en determinar el primer punto no completado del camnino
asignado, luego enviar dicho punto al \emph{controlador de movimiento} y
esperar a que el robot avance lo suficiente hasta este para que se considere
completado. Cuando el punto es completado se repete el proceso con el siguiente
punto sin completar, esto sucede hasta que se completa el ultmo punto el
objetivo.
...
tecnica tiene ventajas de eficiencia ya que el calculo sobre la grilla se
reduce al tamaño del segmento que se debe transitar.
