...
El proyecto se planteó como objetivo mejorar la implementación original de dicha\todo{1. | se pierde un poco a qué se refiere 'dicha'. quizás agregar info diciendo que lo que se pretenden mejorar son implementaciones previas}
estrategia de coordinación, resultando en cinco propuestas
sobre aspectos específicos de la estrategia y del problema de exploración
multi-robot en general.
