...
El proyecto se planteó como objetivo mejorar la implementación original de dicha estrategia de coordinación, resultando en cinco propuestas sobre aspectos específicos de la estrategia y del problema de exploración multi-robot en general\todo{alternativamente, El presente proyecto de grado se planteó realizar aportes en cinco aspectos que mejoran una propuesta relevada en el estado del arte. luego, habría que sustituir propuesta(s) por aporte y acomodar un poquito el texto}.
...
La cuarta propuesta introduce un algoritmo de asignación de objetivos de exploración
...
\todo[inline]{2. | la última oración, a modo de síntesis de conclusiones, me dejó gusto a poco.}
