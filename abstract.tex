...
consiste en utilizar un robot para a través de sus sensores obtener información
de un entorno desconocido con el objetivo de generar un mapa que lo represente.
Por motivos de eficiencia y robustez la exploración suele llevarse a cabo con
más de un robot, en este caso el problema se conoce como el de exploración multirobot.
...
utiliza mas de un robot es deseable que la asignación de objetivos se lleve
...
humanas son entornos que penden dividirse en segmentos, como como habitaciones
