...
\addcontentsline{toc}{chapter}{Índice de figuras}\listoffigures  % facundo
\addcontentsline{toc}{chapter}{Índice de cuadros}\listoftables   % facundo
\addcontentsline{toc}{chapter}{Índice de algoritmos}\listofalgorithms % facundo
